...
if (isset($_GET['refernum']) && is_string($_GET['refernum'])) {
    ...
    if ($result) {
        // Deletion successful
        echo '<script>alert("Consultation Message Deletion Successful."); window.location.href = "searchpreviewconsultation.php";</script>';
        exit;
    } else {
        // Error handling
    ...
    echo '<script>window.location.href = "searchpreviewconsultation.php";</script>';
    exit;
}
?>
