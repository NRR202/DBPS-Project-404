...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2024 at 04:35 AM
...
INSERT INTO `conslutation_message_table` (`references_num`, `from_user_name`, `to_user_name`, `message_from_user`, `message_to_user`, `status_message`) VALUES
(1, 'test1', 'test2', 'Hi', 'Thank you reach out for your concern about your child evaluation. We will be working on it to help him and ensure to finished of his task. Thank you.', 'Completed'),
(2147483647, 'usertest', 'King Olgado', 'Testing Message', 'Working On it.', 'On-Going');
...
(9, '2020-00590', 'Neil Gabriel Ramos                                ', 'sasdzs', 'BSCPE', 'C         ', '3rd year', 'Teresita Ramos', 'Excellent', 'Very Good', 'Good', 'Very Good', 'Very Good', 'Very Good', 'Very Good', 'Very Good', 'Very Good', 'Observed', 'Good', 'Good', 'Very Good', 'Excellent', 'Excellent', 'Very Good', 'Excellent', 'Observed', 'Good', 'Good', 1),
...
INSERT INTO `evaluationstatus` (`UserID`, `Status_E`) VALUES
('2020-00590', 1),
('2022-00180', 0),
('2022-00781', 1),
('2022-01236', 0),
...
('Heather', 'Andres', 'BSCS', 'B', '3rd year', '2024-30421', 'F'),
('John Anderson', 'Censon', 'BSCPE', 'D', '1st year', '2024-90210', 'M');
...
ALTER TABLE `conslutation_message_table`
  ADD PRIMARY KEY (`references_num`);
...
ALTER TABLE `evaluationformtable`
  ...
  ADD UNIQUE KEY `Student` (`Student_ID`);

--
-- Indexes for table `evaluationstatus`
--
...
--
ALTER TABLE `evaluationformtable`
  MODIFY `EvaluationForm_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- Constraints for table `evaluationstatus`
--
ALTER TABLE `evaluationstatus`
  ADD CONSTRAINT `evaluationstatus_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `credentials_account` (`username`);
